...
Java_com_example_wyopengl_WonderfulOpenCv_initNative(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_wyopengl_WonderfulOpenCv_setSurfaceNative(JNIEnv *env, jobject thiz,
                                                           jobject surface) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_wyopengl_WonderfulOpenCv_renderFrameNative(JNIEnv *env, jobject thiz,
...
Java_com_example_wyopengl_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
